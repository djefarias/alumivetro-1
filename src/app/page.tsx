...
export default function HomePage() {
  ...
  return (
    <>
      {/* ==================== HERO ==================== */}
      <section className="relative min-h-[85vh] flex items-center bg-gradient-to-br from-[#0f1f3d] via-[#1a365d] to-[#2b4f8c] overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-10 left-10 w-72 h-72 bg-[#e8a838] rounded-full blur-3xl" />
          <div className="absolute bottom-10 right-10 w-96 h-96 bg-[#e8a838] rounded-full blur-3xl" />
        </div>
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center lg:text-left">
          <div className="lg:max-w-2xl">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm text-[#e8a838] text-sm font-medium px-4 py-2 rounded-full mb-6">
              <span className="w-2 h-2 bg-[#e8a838] rounded-full animate-pulse" />
              Qualidade e Excelência em Alumínio
            </div>
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
              Sua obra merece o{" "}
              <span className="text-[#e8a838]">melhor acabamento</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <a
                ...
                className="btn-outline !border-white !text-white hover:!bg-white hover:!text-[#1a365d] text-center"
              >
                Fale Conosco
              </a>
            </div>
        ...
        <div className="hidden lg:block absolute right-0 top-1/2 -translate-y-1/2 w-1/3 h-3/4 opacity-10">
          <div className="w-full h-full bg-gradient-to-l from-[#e8a838] to-transparent" style={{ clipPath: "polygon(100% 0, 0 50%, 100% 100%)" }} />
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="relative">
              <div className="aspect-[4/3] bg-gradient-to-br from-[#1a365d] to-[#2b4f8c] rounded-2xl flex items-center justify-center p-8">
                <div className="text-center text-white">
                  <div className="text-6xl font-bold text-[#e8a838] mb-2">+10</div>
                  <div className="text-lg">Anos de Experiência</div>
                  <div className="mt-6 flex gap-8 justify-center text-sm">
                    <div><span className="text-[#e8a838] font-bold text-xl">+50</span><br />Obras Realizadas</div>
                    <div><span className="text-[#e8a838] font-bold text-xl">100%</span><br />Satisfação</div>
                  </div>
                </div>
              </div>
            </div>
            <div>
              <h2 className="text-sm font-semibold text-[#e8a838] uppercase tracking-wider mb-2">
                Sobre Nós
              </h2>
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                {["Equipe especializada", "Materiais premium", "Orçamento sem compromisso", "Garantia nos serviços"].map((item) => (
                  <div key={item} className="flex items-center gap-2 text-gray-700">
                    <svg className="w-5 h-5 text-[#e8a838] flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={i}
                className="group p-8 rounded-xl border border-gray-100 hover:border-[#e8a838]/30 hover:shadow-lg transition-all duration-300"
              >
                <div className="w-14 h-14 rounded-lg bg-[#1a365d]/5 text-[#1a365d] flex items-center justify-center mb-5 group-hover:bg-[#1a365d] group-hover:text-white transition-all duration-300">
                  {servico.icon}
                </div>
                <h4 className="text-lg font-bold text-[#1a365d] mb-3">{servico.title}</h4>
      ...
      {/* ==================== CTA / CONTATO ==================== */}
      <section id="contato" className="py-20 bg-[#1a365d] relative overflow-hidden">
        <div className="absolute inset-0 opacity-5">
          <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-[#e8a838] to-transparent" style={{ clipPath: "polygon(100% 0, 0 50%, 100% 100%)" }} />
        </div>
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-[#e8a838] hover:bg-[#d49520] text-white font-bold py-4 px-10 rounded-lg transition-all duration-300 text-lg inline-flex items-center gap-2"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-white hover:bg-gray-100 text-[#1a365d] font-bold py-4 px-10 rounded-lg transition-all duration-300 text-lg inline-flex items-center gap-2"
            >
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      {lightbox && (
        ...
        >
          <button
            className="absolute top-4 right-4 text-white text-3xl hover:text-[#e8a838] transition-colors"
            onClick={() => setLightbox(null)}
          >
            ✕
          </button>
